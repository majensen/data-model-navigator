...
/**
 * This method will execute only once during data initialization
 * @param {*} dictionary
 * 12/20/2022 - AR
 * Simple Breadth First Search to assign node to a tree
    ...
    links.forEach((link, linkIndex) => {
      ...
      if (target && source) {
        ...
        if (distinctLinks[source] === target) {
          ...
          node2Level[target] += nextLevel / interval;
        } else {
...
export const getNodePosition = ({
  ...
  for (const [level, nodes] of Object.entries(subtree)) {
    ...
    /**
         ...
         * yInterval to adjust the distance between each level
         */
